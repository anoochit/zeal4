...
class TextWidgetView2 extends StatefulWidget {
  const TextWidgetView2({
    super.key,
    required this.name,
  ...
  @override
  State<TextWidgetView2> createState() => _TextWidgetView2State();
}

class _TextWidgetView2State extends State<TextWidgetView2> {
  // device log
  DeviceLog? deviceLog;
