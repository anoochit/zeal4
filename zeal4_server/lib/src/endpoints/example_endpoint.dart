...
class ExampleEndpoint extends Endpoint {
  ...
  Stream<int> countdown(Session session) async* {
    // This function counts down from 10 to 0, yielding each number as a Stream event.
    // It also includes a delay of 1 second between each yield to simulate a countdown timer.
    for (var i = 10; i >= 0; i--) {
      // Yield the current value of i to the Stream.
      yield i;
